...
import { SupplierInvoiceInventoryModule } from 'src/inventory/supplier-invoice-inventory/supplier-invoice-inventory.module';

@Module({
  imports: [
    AuthModule,
    SupplierInvoiceInventoryModule,
    TypeOrmModule.forFeature([SupplierInvoice, Company, Supplier]),
  ],
