...
import { LoyaltyRewardsRedemption } from 'src/growth/loyalty/loyalty-rewards-redemptions/entities/loyalty-rewards-redemption.entity';
...
export class LoyaltyCustomer {
  ...
  @OneToMany(() => LoyaltyRewardsRedemption, (loyaltyRewardsRedemption) => loyaltyRewardsRedemption.loyaltyCustomer)
