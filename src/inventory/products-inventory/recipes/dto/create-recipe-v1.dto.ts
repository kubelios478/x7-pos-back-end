...
export class RecipeLineV1Dto {
  ...
  @ApiProperty({
    example: 'grams',
    description: 'Unit of measure (in consumption units)',
  })
  @IsString()
  @IsNotEmpty()
  ...
  @ApiPropertyOptional({
    example: 150.5,
    description: 'Quantity per sold unit (optional)',
  })
  @IsOptional()
  @IsNumber()
  ...
  @ApiPropertyOptional({
    example: 1.25,
    description: 'Cost contribution (optional)',
  })
  @IsOptional()
  @IsNumber()
...
export class CreateRecipeV1Dto {
  @ApiProperty({
    example: 1,
    description: 'Product ID to assign the recipe to',
  })
  @IsInt()
  @Min(1)
  productId: number;
